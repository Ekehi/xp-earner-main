...
const HomeTab = () => {
  return (
    <div className="container"> {/* Added a container class */}
      ...
      <ul className="hidden text-sm font-medium text-center text-gray-500 rounded-lg shadow sm:flex dark:divide-gray-700 dark:text-gray-400"> {/* Replace with your desired styles */}
