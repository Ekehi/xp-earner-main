...
const Tasks = () => {
    ...
    return (
        <div className="h-full w-full ">
            ...
            <nav className="fixed bottom-0 flex justify-between bg-white solid overflow-auto rounded-md">
                {[
                    ...
                    <Link
                        ...
                        key={index}
                        className={`relative flex flex-col justify-center items-center gap-1 w-5 p-5 mx-0 my-1 transition ${activeIndex === index ? 'is-active' : ''
                            }`}
