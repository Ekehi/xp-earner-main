...
function App() {
        ...
        return (
            <div className="flex flex-row  container w-screen h-screen m-auto justify-items-center">
                <div className="relative flex self-center m-auto w-full">
                    <svg aria-hidden="true" class="inline m-auto w-50 h-50  text-black animate-spin dark:text-gray-600 fill-yellow-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        ...
        <nav className="absolute justify-between bottom-0 flex bg-white solid w-3/4 rounded-md h-fit  ">
                {[
                    ...
                    <Link
                        ...
                        key={index}
                        className={`relative flex flex-col text-yellow-500 justify-center h-1 items-center gap-1  p-5 transition ${activeIndex === index ? 'is-active' : ''
                            }`}
